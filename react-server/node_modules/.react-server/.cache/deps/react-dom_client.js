import {
  require_react_dom
} from "./chunk-CF46TAFV.js";
import {
  require_react
} from "./chunk-2XW3NNT3.js";
import {
  __commonJS
  ...
  "node_modules/react-dom/cjs/react-dom-client.development.js"(exports) {
    ...
    (function() {
      ...
      function startUpdateTimerByLane(lane) {
        ...
        if (JSCompiler_temp)
          0 > blockingUpdateTime && (blockingUpdateTime = now(), (executionContext & (RenderContext | CommitContext)) !== NoContext && (blockingSpawnedUpdate = true), lane = resolveEventTimeStamp(), JSCompiler_temp = resolveEventType(), lane !== blockingEventTime || JSCompiler_temp !== blockingEventType ? blockingEventIsRepeat = false : null !== JSCompiler_temp && (blockingSpawnedUpdate = true), blockingEventTime = lane, blockingEventType = JSCompiler_temp);
        else if (0 !== (lane & 4194176) && 0 > transitionUpdateTime && (transitionUpdateTime = now(), 0 > transitionStartTime)) {
      ...
      function setCurrentTrackFromLanes(lanes) {
        reusableLaneDevToolDetails.track = lanes & 63 ? "Blocking" : lanes & 4194240 ? "Transition" : lanes & 62914560 ? "Suspense" : lanes & 2080374784 ? "Idle" : "Other";
      }
      function logComponentRender(fiber, startTime, endTime, wasHydrated) {
        ...
        if (null !== name && supportsUserTiming) {
          ...
          reusableComponentDevToolDetails.color = 0.5 > selfTime ? wasHydrated ? "tertiary-light" : "primary-light" : 10 > selfTime ? wasHydrated ? "tertiary" : "primary" : 100 > selfTime ? wasHydrated ? "tertiary-dark" : "primary-dark" : "error";
      ...
      function logComponentEffect(fiber, startTime, endTime, selfTime, errors) {
        if (null !== errors) {
          if (supportsUserTiming && (selfTime = getComponentNameFromFiber(fiber), null !== selfTime)) {
            fiber = [];
          ...
          errors = getComponentNameFromFiber(fiber), null !== errors && supportsUserTiming && (reusableComponentDevToolDetails.color = 1 > selfTime ? "secondary-light" : 100 > selfTime ? "secondary" : 500 > selfTime ? "secondary-dark" : "error", reusableComponentOptions.start = startTime, reusableComponentOptions.end = endTime, performance.measure(errors, reusableComponentOptions));
      }
      function logRenderPhase(startTime, endTime, lanes) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = (lanes & 738197589) === lanes ? "tertiary-dark" : "primary-dark", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure(
          (lanes & 536870912) === lanes ? "Prepared" : (lanes & 201326677) === lanes ? "Hydrated" : "Render",
          reusableLaneOptions
        ));
      }
      function logSuspendedRenderPhase(startTime, endTime, lanes) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = (lanes & 738197589) === lanes ? "tertiary-dark" : "primary-dark", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure("Prewarm", reusableLaneOptions));
      }
      function logSuspendedWithDelayPhase(startTime, endTime, lanes) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = (lanes & 738197589) === lanes ? "tertiary-dark" : "primary-dark", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure("Suspended", reusableLaneOptions));
      }
      function logRecoveredRenderPhase(startTime, endTime, lanes, recoverableErrors, hydrationFailed) {
        if (supportsUserTiming) {
          lanes = [];
      ...
      function logErroredRenderPhase(startTime, endTime) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = "error", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure("Errored", reusableLaneOptions));
      }
      function logSuspenseThrottlePhase(startTime, endTime) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = "secondary-light", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure("Throttled", reusableLaneOptions));
      }
      function logSuspendedCommitPhase(startTime, endTime) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = "secondary-light", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure("Suspended", reusableLaneOptions));
      }
      ...
      function getTreeId() {
        var overflow = treeContextOverflow, idWithLeadingBit = treeContextId;
        return (idWithLeadingBit & ~(1 << 32 - clz32(idWithLeadingBit) - 1)).toString(32) + overflow;
      }
      ...
      function mountId() {
        ...
        if (isHydrating) {
          ...
          treeId = globalClientIdCounter$1++, identifierPrefix = ":" + identifierPrefix + "r" + treeId.toString(32) + ":";
        ...
        for (var provider = fiber.return; null !== provider; ) {
          switch (provider.tag) {
            ...
            case 3:
              ...
              null !== root2 && (startUpdateTimerByLane(lane), scheduleUpdateOnFiber(root2, provider, lane), entangleTransitions(root2, provider, lane));
      ...
      function dispatchReducerAction(fiber, queue, action) {
        ...
        isRenderPhaseUpdate(fiber) ? enqueueRenderPhaseUpdate(queue, update) : (update = enqueueConcurrentHookUpdate(fiber, queue, update, args), null !== update && (startUpdateTimerByLane(args), scheduleUpdateOnFiber(update, fiber, args), entangleTransitionUpdate(update, queue, args)));
      }
      function dispatchSetState(fiber, queue, action) {
        ...
        args = requestUpdateLane(fiber);
        dispatchSetStateInternal(fiber, queue, action, args) && startUpdateTimerByLane(args);
      }
      ...
      function dispatchOptimisticSetState(fiber, throwIfDuringRender, queue, action) {
        ...
        if (isRenderPhaseUpdate(fiber)) {
          ...
          throwIfDuringRender = enqueueConcurrentHookUpdate(
            ...
            action,
            2
          ), null !== throwIfDuringRender && (startUpdateTimerByLane(2), scheduleUpdateOnFiber(throwIfDuringRender, fiber, 2));
      }
      ...
      function createChildReconciler(shouldTrackSideEffects) {
        ...
        function reconcileChildrenAsyncIteratable(returnFiber, currentFirstChild, newChildrenIterable, lanes) {
          ...
          newChildren !== newChildrenIterable || 0 === returnFiber.tag && "[object AsyncGeneratorFunction]" === Object.prototype.toString.call(returnFiber.type) && "[object AsyncGenerator]" === Object.prototype.toString.call(newChildren) || (didWarnAboutGenerators || console.error(
      ...
      function resetSuspendedComponent(sourceFiber, rootRenderLanes) {
        ...
        null !== currentSourceFiber && propagateParentContextChanges(
          currentSourceFiber,
          sourceFiber,
          rootRenderLanes,
          true
      ...
      function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
        var JSCompiler_object_inline_componentStack_2544;
        var JSCompiler_object_inline_stack_2543 = workInProgress2.pendingProps;
        shouldSuspendImpl(workInProgress2) && (workInProgress2.flags |= 128);
        var JSCompiler_object_inline_message_2541 = false;
        var didSuspend = 0 !== (workInProgress2.flags & 128);
        (JSCompiler_object_inline_componentStack_2544 = didSuspend) || (JSCompiler_object_inline_componentStack_2544 = null !== current2 && null === current2.memoizedState ? false : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_componentStack_2544 && (JSCompiler_object_inline_message_2541 = true, workInProgress2.flags &= -129);
        JSCompiler_object_inline_componentStack_2544 = 0 !== (workInProgress2.flags & 32);
        workInProgress2.flags &= -33;
        if (null === current2) {
          if (isHydrating) {
            JSCompiler_object_inline_message_2541 ? pushPrimaryTreeSuspenseHandler(workInProgress2) : reuseSuspenseHandlerOnStack(workInProgress2);
            if (isHydrating) {
              var JSCompiler_object_inline_digest_2542 = nextHydratableInstance;
              var JSCompiler_temp;
              if (!(JSCompiler_temp = !JSCompiler_object_inline_digest_2542)) {
                c: {
                  var instance = JSCompiler_object_inline_digest_2542;
            ...
            JSCompiler_object_inline_digest_2542 = workInProgress2.memoizedState;
            if (null !== JSCompiler_object_inline_digest_2542 && (JSCompiler_object_inline_digest_2542 = JSCompiler_object_inline_digest_2542.dehydrated, null !== JSCompiler_object_inline_digest_2542))
              return isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2542) ? workInProgress2.lanes = 32 : workInProgress2.lanes = 536870912, null;
            popSuspenseHandler(workInProgress2);
          }
          JSCompiler_object_inline_digest_2542 = JSCompiler_object_inline_stack_2543.children;
          JSCompiler_temp = JSCompiler_object_inline_stack_2543.fallback;
          if (JSCompiler_object_inline_message_2541)
            return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_stack_2543 = mountSuspenseFallbackChildren(
              workInProgress2,
              JSCompiler_object_inline_digest_2542,
              JSCompiler_temp,
              renderLanes2
            ), JSCompiler_object_inline_message_2541 = workInProgress2.child, JSCompiler_object_inline_message_2541.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_message_2541.childLanes = getRemainingWorkInPrimaryTree(
              current2,
              JSCompiler_object_inline_componentStack_2544,
              renderLanes2
            ), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2543;
          if ("number" === typeof JSCompiler_object_inline_stack_2543.unstable_expectedLoadTime)
            return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_stack_2543 = mountSuspenseFallbackChildren(
              workInProgress2,
              JSCompiler_object_inline_digest_2542,
              JSCompiler_temp,
              ...
              JSCompiler_object_inline_componentStack_2544,
              renderLanes2
            ), workInProgress2.memoizedState = SUSPENDED_MARKER, workInProgress2.lanes = 4194304, JSCompiler_object_inline_stack_2543;
        ...
        if (null !== prevState && (JSCompiler_object_inline_digest_2542 = prevState.dehydrated, null !== JSCompiler_object_inline_digest_2542)) {
          if (didSuspend)
            workInProgress2.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress2), workInProgress2.flags &= -257, workInProgress2 = retrySuspenseComponentWithoutHydrating(
              current2,
              workInProgress2,
              renderLanes2
            )) : null !== workInProgress2.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress2), workInProgress2.child = current2.child, workInProgress2.flags |= 128, workInProgress2 = null) : (reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_message_2541 = JSCompiler_object_inline_stack_2543.fallback, JSCompiler_object_inline_digest_2542 = workInProgress2.mode, JSCompiler_object_inline_stack_2543 = mountWorkInProgressOffscreenFiber(
              {
                mode: "visible",
                children: JSCompiler_object_inline_stack_2543.children
              },
              JSCompiler_object_inline_digest_2542
            ), JSCompiler_object_inline_message_2541 = createFiberFromFragment(
              JSCompiler_object_inline_message_2541,
              JSCompiler_object_inline_digest_2542,
              renderLanes2,
              null
            ), JSCompiler_object_inline_message_2541.flags |= 2, JSCompiler_object_inline_stack_2543.return = workInProgress2, JSCompiler_object_inline_message_2541.return = workInProgress2, JSCompiler_object_inline_stack_2543.sibling = JSCompiler_object_inline_message_2541, workInProgress2.child = JSCompiler_object_inline_stack_2543, reconcileChildFibers(
              workInProgress2,
              current2.child,
              null,
              renderLanes2
            ), JSCompiler_object_inline_stack_2543 = workInProgress2.child, JSCompiler_object_inline_stack_2543.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_stack_2543.childLanes = getRemainingWorkInPrimaryTree(
              current2,
              JSCompiler_object_inline_componentStack_2544,
              renderLanes2
            ), workInProgress2.memoizedState = SUSPENDED_MARKER, workInProgress2 = JSCompiler_object_inline_message_2541);
          else if (pushPrimaryTreeSuspenseHandler(workInProgress2), isHydrating && console.error(
            "We should not be hydrating here. This is a bug in React. Please file a bug."
          ), isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2542)) {
            JSCompiler_object_inline_componentStack_2544 = JSCompiler_object_inline_digest_2542.nextSibling && JSCompiler_object_inline_digest_2542.nextSibling.dataset;
            if (JSCompiler_object_inline_componentStack_2544) {
              JSCompiler_temp = JSCompiler_object_inline_componentStack_2544.dgst;
              var message = JSCompiler_object_inline_componentStack_2544.msg;
              instance = JSCompiler_object_inline_componentStack_2544.stck;
              var componentStack = JSCompiler_object_inline_componentStack_2544.cstck;
            }
            JSCompiler_object_inline_message_2541 = message;
            JSCompiler_object_inline_digest_2542 = JSCompiler_temp;
            JSCompiler_object_inline_stack_2543 = instance;
            JSCompiler_temp = JSCompiler_object_inline_componentStack_2544 = componentStack;
            "POSTPONE" !== JSCompiler_object_inline_digest_2542 && (JSCompiler_object_inline_componentStack_2544 = JSCompiler_object_inline_message_2541 ? Error(JSCompiler_object_inline_message_2541) : Error(
              "The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."
            ), JSCompiler_object_inline_componentStack_2544.stack = JSCompiler_object_inline_stack_2543 || "", JSCompiler_object_inline_componentStack_2544.digest = JSCompiler_object_inline_digest_2542, JSCompiler_object_inline_stack_2543 = void 0 === JSCompiler_temp ? null : JSCompiler_temp, JSCompiler_object_inline_message_2541 = {
              value: JSCompiler_object_inline_componentStack_2544,
              source: null,
              stack: JSCompiler_object_inline_stack_2543
            }, "string" === typeof JSCompiler_object_inline_stack_2543 && CapturedStacks.set(
              JSCompiler_object_inline_componentStack_2544,
              JSCompiler_object_inline_message_2541
            ), queueHydrationError(JSCompiler_object_inline_message_2541));
            ...
            renderLanes2,
            false
          ), JSCompiler_object_inline_componentStack_2544 = 0 !== (renderLanes2 & current2.childLanes), didReceiveUpdate || JSCompiler_object_inline_componentStack_2544) {
            JSCompiler_object_inline_componentStack_2544 = workInProgressRoot;
            if (null !== JSCompiler_object_inline_componentStack_2544 && (JSCompiler_object_inline_stack_2543 = renderLanes2 & -renderLanes2, JSCompiler_object_inline_stack_2543 = 0 !== (JSCompiler_object_inline_stack_2543 & 42) ? 1 : getBumpedLaneForHydrationByLane(
              JSCompiler_object_inline_stack_2543
            ), JSCompiler_object_inline_stack_2543 = 0 !== (JSCompiler_object_inline_stack_2543 & (JSCompiler_object_inline_componentStack_2544.suspendedLanes | renderLanes2)) ? 0 : JSCompiler_object_inline_stack_2543, 0 !== JSCompiler_object_inline_stack_2543 && JSCompiler_object_inline_stack_2543 !== prevState.retryLane))
              throw prevState.retryLane = JSCompiler_object_inline_stack_2543, enqueueConcurrentRenderForLane(
                current2,
                JSCompiler_object_inline_stack_2543
            ...
            JSCompiler_object_inline_digest_2542.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
            workInProgress2 = retrySuspenseComponentWithoutHydrating(
              current2,
              workInProgress2,
              renderLanes2
            ...
            JSCompiler_object_inline_digest_2542.data === SUSPENSE_PENDING_START_DATA ? (workInProgress2.flags |= 192, workInProgress2.child = current2.child, workInProgress2 = null) : (current2 = prevState.treeContext, nextHydratableInstance = getNextHydratable(
              JSCompiler_object_inline_digest_2542.nextSibling
        ...
        if (JSCompiler_object_inline_message_2541)
          return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_message_2541 = JSCompiler_object_inline_stack_2543.fallback, JSCompiler_object_inline_digest_2542 = workInProgress2.mode, JSCompiler_temp = current2.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2543 = createWorkInProgress(
            JSCompiler_temp,
            {
              mode: "hidden",
              children: JSCompiler_object_inline_stack_2543.children
            }
          ), JSCompiler_object_inline_stack_2543.subtreeFlags = JSCompiler_temp.subtreeFlags & 65011712, null !== instance ? JSCompiler_object_inline_message_2541 = createWorkInProgress(
            instance,
            JSCompiler_object_inline_message_2541
          ) : (JSCompiler_object_inline_message_2541 = createFiberFromFragment(
            JSCompiler_object_inline_message_2541,
            ...
            renderLanes2,
            null
          ), JSCompiler_object_inline_message_2541.flags |= 2), JSCompiler_object_inline_message_2541.return = workInProgress2, JSCompiler_object_inline_stack_2543.return = workInProgress2, JSCompiler_object_inline_stack_2543.sibling = JSCompiler_object_inline_message_2541, workInProgress2.child = JSCompiler_object_inline_stack_2543, JSCompiler_object_inline_stack_2543 = JSCompiler_object_inline_message_2541, JSCompiler_object_inline_message_2541 = workInProgress2.child, JSCompiler_object_inline_digest_2542 = current2.child.memoizedState, null === JSCompiler_object_inline_digest_2542 ? JSCompiler_object_inline_digest_2542 = mountSuspenseOffscreenState(renderLanes2) : (JSCompiler_temp = JSCompiler_object_inline_digest_2542.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? { parent: instance, pool: instance } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_digest_2542 = {
            baseLanes: JSCompiler_object_inline_digest_2542.baseLanes | renderLanes2,
            cachePool: JSCompiler_temp
          }), JSCompiler_object_inline_message_2541.memoizedState = JSCompiler_object_inline_digest_2542, JSCompiler_object_inline_message_2541.childLanes = getRemainingWorkInPrimaryTree(
            current2,
            JSCompiler_object_inline_componentStack_2544,
            renderLanes2
          ), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2543;
        ...
        null !== current2 && (JSCompiler_object_inline_componentStack_2544 = workInProgress2.deletions, null === JSCompiler_object_inline_componentStack_2544 ? (workInProgress2.deletions = [current2], workInProgress2.flags |= 16) : JSCompiler_object_inline_componentStack_2544.push(current2));
      ...
      function beginWork(current2, workInProgress2, renderLanes2) {
        ...
        switch (workInProgress2.tag) {
          ...
          case 30:
            return returnFiber = workInProgress2.pendingProps, prevSibling = workInProgress2.stateNode, null != returnFiber.name && "auto" !== returnFiber.name ? workInProgress2.flags |= null === current2 ? 18882560 : 18874368 : null === prevSibling.autoName && (nextProps = workInProgressRoot.identifierPrefix, isHydrating ? (nextState = getTreeId(), nextProps = "«" + nextProps + "T" + nextState + "»") : (nextState = globalClientIdCounter++, nextProps = "«" + nextProps + "t" + nextState.toString(32) + "»"), prevSibling.autoName = nextProps), null !== current2 && current2.memoizedProps.name !== returnFiber.name ? workInProgress2.flags |= 4194816 : markRef(current2, workInProgress2), reconcileChildren(
              current2,
              workInProgress2,
          ...
          if (null !== lastEffect) {
            ...
            do {
              if ((updateQueue.tag & flags) === flags) {
                ...
                void 0 !== destroy && (inst.destroy = void 0, (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = true), runWithFiberInDEV(
                  finishedWork,
                  callDestroyInDEV,
                  finishedWork,
                  nearestMountedAncestor,
          ...
          if (before) {
            switch (parent.nodeType) {
              ...
              case 9:
                ...
                break;
              default:
                parent = "HTML" === parent.nodeName ? parent.ownerDocument.body : parent;
            }
            ...
            a: {
              switch (parent.nodeType) {
                ...
                case 9:
                  ...
                  break;
                default:
                  before = "HTML" === parent.nodeName ? parent.ownerDocument.body : parent;
              }
              before.appendChild(node);
              parent = parent._reactRootContainer;
              null !== parent && void 0 !== parent || null !== before.onclick || (before.onclick = noop$1);
            }
      ...
      function insertOrAppendPlacementNode(node, before, parent) {
        var tag = node.tag;
        if (5 === tag || 6 === tag)
          node = node.stateNode, before ? parent.insertBefore(node, before) : parent.appendChild(node), viewTransitionMutationContext = true;
        else if (4 !== tag && (27 === tag && "head" === node.type && (parent = node.stateNode), node = node.child, null !== node))
      ...
      function commitBeforeMutationEffects(root2, firstChild, committedLanes) {
        ...
        shouldStartViewTransition = _enabled = false;
      ...
      function commitBeforeMutationEffects_complete(isViewTransitionEligible$jscomp$0) {
        for (; null !== nextEffect; ) {
          ...
          switch (finishedWork.tag) {
            case 0:
              if (0 !== (flags & 4) && (isViewTransitionEligible = finishedWork.updateQueue, isViewTransitionEligible = null !== isViewTransitionEligible ? isViewTransitionEligible.events : null, null !== isViewTransitionEligible))
                for (finishedWork = 0; finishedWork < isViewTransitionEligible.length; finishedWork++)
                  current2 = isViewTransitionEligible[finishedWork], current2.ref.impl = current2.nextImpl;
              break;
            case 11:
            case 15:
              break;
            ...
            case 17:
              break;
            case 30:
              if (isViewTransitionEligible && null !== current2 && 0 !== (finishedWork.subtreeFlags & 8246))
                a: {
                  isViewTransitionEligible = current2;
                  ...
                  current2 = current2.memoizedProps;
                  flags = getViewTransitionClassName(
                    current2.className,
                    current2.update
                  );
                  if ("none" === flags && (flags = getViewTransitionClassName(
                    current2.className,
                    current2.layout
                  ), "none" === flags))
                    break a;
      ...
      function applyViewTransitionToHostInstances(child, name, className, collectMeasurements, stopAtNestedViewTransitions) {
        for (var inViewport = false; null !== child; ) {
          if (5 === child.tag) {
            ...
            instance.style.viewTransitionName = 0 === viewTransitionHostInstanceIdx ? name : name + "_" + viewTransitionHostInstanceIdx;
            null != measurement && (instance.style.viewTransitionClass = measurement);
            viewTransitionHostInstanceIdx++;
          } else if (22 !== child.tag || null === child.memoizedState)
            30 === child.tag && stopAtNestedViewTransitions || applyViewTransitionToHostInstances(
              child.child,
              name,
              className,
              collectMeasurements,
          ...
          for (placement = placement.child; null !== placement; ) {
            if (22 !== placement.tag || null !== placement.memoizedState) {
              if (commitAppearingPairViewTransitions(placement), 30 === placement.tag && 0 !== (placement.flags & 18874368) && placement.stateNode.paired) {
                ...
                "none" !== props && (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(
                  placement.child,
                  name,
                  props,
                  null,
      ...
      function commitEnterViewTransitions(placement) {
        if (30 === placement.tag) {
          ...
          "none" !== className ? (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(
            placement.child,
            name,
            className,
            null,
            false
          ) ? (commitAppearingPairViewTransitions(placement), state.paired || scheduleViewTransitionEvent(placement, props.onEnter)) : restoreViewTransitionOnHostInstances(placement.child, false)) : commitAppearingPairViewTransitions(placement);
                  ...
                  if (null != name && "auto" !== name) {
                    ...
                    if (void 0 !== pair) {
                      ...
                      "none" !== className && (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(
                        ...
                        null,
                        false
                      ) ? (pair.paired = deletion.stateNode, scheduleViewTransitionEvent(deletion, props.onShare)) : restoreViewTransitionOnHostInstances(
                        deletion.child,
                        false
                      ));
                      pairs.delete(name);
      ...
      function commitExitViewTransitions(deletion) {
        if (30 === deletion.tag) {
          ...
          "none" !== className && (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(
            ...
            null,
            false
          ) ? void 0 !== pair ? (pair.paired = deletion.stateNode, appearingViewTransitions.delete(name), scheduleViewTransitionEvent(deletion, props.onShare)) : scheduleViewTransitionEvent(deletion, props.onExit) : restoreViewTransitionOnHostInstances(deletion.child, false));
      ...
      function restoreEnterViewTransitions(placement) {
        if (30 === placement.tag)
          placement.stateNode.paired = null, restoreViewTransitionOnHostInstances(placement.child, false), restorePairedViewTransitions(placement);
        else if (0 !== (placement.subtreeFlags & 33554432))
          for (placement = placement.child; null !== placement; )
      ...
      function restoreExitViewTransitions(deletion) {
        if (30 === deletion.tag)
          deletion.stateNode.paired = null, restoreViewTransitionOnHostInstances(deletion.child, false), restorePairedViewTransitions(deletion);
        else if (0 !== (deletion.subtreeFlags & 33554432))
          for (deletion = deletion.child; null !== deletion; )
      ...
      function restoreNestedViewTransitions(changedParent) {
        for (changedParent = changedParent.child; null !== changedParent; )
          30 === changedParent.tag ? (changedParent.memoizedState = null, restoreViewTransitionOnHostInstances(changedParent.child, false)) : 0 !== (changedParent.subtreeFlags & 33554432) && restoreNestedViewTransitions(changedParent), changedParent = changedParent.sibling;
      }
      function cancelViewTransitionHostInstances(currentViewTransition, child, stopAtNestedViewTransitions) {
        for (; null !== child; ) {
          if (5 === child.tag) {
            var instance = child.stateNode, oldName = getViewTransitionName(
              currentViewTransition.memoizedProps,
              currentViewTransition.stateNode
            );
            null === viewTransitionCancelableChildren && (viewTransitionCancelableChildren = []);
            ...
            30 === child.tag && stopAtNestedViewTransitions || cancelViewTransitionHostInstances(
      ...
      function measureViewTransitionHostInstances(currentViewTransition, parentViewTransition, child, name, className, previousMeasurements, stopAtNestedViewTransitions) {
        for (var inViewport = false; null !== child; ) {
          if (5 === child.tag) {
            var instance = child.stateNode;
            ...
            0 !== (parentViewTransition.flags & 4) && (nextMeasurement = instance, previousMeasurement = className, nextMeasurement.style.viewTransitionName = 0 === viewTransitionHostInstanceIdx ? name : name + "_" + viewTransitionHostInstanceIdx, null != previousMeasurement && (nextMeasurement.style.viewTransitionClass = previousMeasurement));
            inViewport && 0 !== (parentViewTransition.flags & 4) || (nextMeasurement = getViewTransitionName(
              currentViewTransition.memoizedProps,
              currentViewTransition.stateNode
            ), null === viewTransitionCancelableChildren && (viewTransitionCancelableChildren = []), viewTransitionCancelableChildren.push(
              instance,
              nextMeasurement,
              child.memoizedProps
            ));
            ...
            30 === child.tag && stopAtNestedViewTransitions ? parentViewTransition.flags |= child.flags & 32 : measureViewTransitionHostInstances(
              currentViewTransition,
      ...
      function measureNestedViewTransitions(changedParent) {
        for (changedParent = changedParent.child; null !== changedParent; ) {
          if (30 === changedParent.tag) {
            var current2 = changedParent.alternate;
            if (null !== current2) {
              var props = changedParent.memoizedProps, name = getViewTransitionName(props, changedParent.stateNode), className = getViewTransitionClassName(
                props.className,
                props.layout
              );
              viewTransitionHostInstanceIdx = 0;
              current2 = measureViewTransitionHostInstances(
                current2,
                changedParent,
                changedParent.child,
                name,
              ...
              0 !== (changedParent.flags & 4) && current2 && scheduleViewTransitionEvent(changedParent, props.onLayout);
            }
          } else
      ...
      function commitLayoutEffectOnFiber(finishedRoot, current2, finishedWork) {
        var prevEffectStart = pushComponentEffectStart(), prevEffectErrors = pushComponentEffectErrors(), flags = finishedWork.flags;
        switch (finishedWork.tag) {
          case 0:
          case 11:
          case 15:
        ...
        (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && 0.05 < componentEffectDuration && logComponentEffect(
          finishedWork,
      ...
      function commitDeletionEffectsOnFiber(finishedRoot, nearestMountedAncestor, deletedFiber) {
        ...
        switch (deletedFiber.tag) {
          ...
          case 27:
            ...
            "head" === deletedFiber.type && (hostParent = deletedFiber.stateNode, hostParentIsContainer = false);
            recursivelyTraverseDeletionEffects(
              finishedRoot,
              nearestMountedAncestor,
              deletedFiber
          ...
          case 6:
            ...
            break;
          case 18:
            null !== hostParent && (hostParentIsContainer ? (finishedRoot = hostParent, deletedFiber = deletedFiber.stateNode, 8 === finishedRoot.nodeType ? clearSuspenseBoundary(finishedRoot.parentNode, deletedFiber) : 9 === finishedRoot.nodeType ? clearSuspenseBoundary(finishedRoot.body, deletedFiber) : "HTML" === finishedRoot.nodeName ? clearSuspenseBoundary(
              finishedRoot.ownerDocument.body,
              deletedFiber
            ) : clearSuspenseBoundary(finishedRoot, deletedFiber), retryIfBlockedOn(finishedRoot)) : clearSuspenseBoundary(hostParent, deletedFiber.stateNode));
            break;
          case 4:
            prevHostParent = hostParent;
            prevHostParentIsContainer = hostParentIsContainer;
      ...
      function commitMutationEffectsOnFiber(finishedWork, root2, lanes) {
        var prevEffectStart = pushComponentEffectStart(), prevEffectErrors = pushComponentEffectErrors(), current2 = finishedWork.alternate, flags = finishedWork.flags;
        switch (finishedWork.tag) {
          case 0:
          case 11:
          case 14:
          ...
          case 1:
            ...
            flags & 64 && offscreenSubtreeIsHidden && (current2 = finishedWork.updateQueue, null !== current2 && (flags = current2.callbacks, null !== flags && (root2 = current2.shared.hiddenCallbacks, current2.shared.hiddenCallbacks = null === root2 ? flags : root2.concat(flags))));
            break;
          case 26:
              ...
              if (root2 = null !== current2 ? current2.memoizedState : null, flags = finishedWork.memoizedState, null === current2)
                if (null === flags)
                  if (null === finishedWork.stateNode) {
                      ...
                      b: switch (current2) {
                        case "title":
                          ...
                          if (!lanes || lanes[internalHoistableMarker] || lanes[internalInstanceKey] || lanes.namespaceURI === SVG_NAMESPACE || lanes.hasAttribute("itemprop"))
                            lanes = root2.createElement(current2), root2.head.insertBefore(
                              lanes,
                              root2.querySelector("head > title")
                            );
                          setInitialProperties(lanes, current2, flags);
                        ...
                        case "link":
                          if (hoistableRoot = getHydratableHoistableCache(
                            ...
                            "href",
                            root2
                          ).get(current2 + (flags.href || ""))) {
                            for (var i = 0; i < hoistableRoot.length; i++)
                              if (lanes = hoistableRoot[i], lanes.getAttribute("href") === (null == flags.href || "" === flags.href ? null : flags.href) && lanes.getAttribute("rel") === (null == flags.rel ? null : flags.rel) && lanes.getAttribute("title") === (null == flags.title ? null : flags.title) && lanes.getAttribute("crossorigin") === (null == flags.crossOrigin ? null : flags.crossOrigin)) {
                                hoistableRoot.splice(i, 1);
                                break b;
                              }
                          }
                          lanes = root2.createElement(current2);
                          setInitialProperties(lanes, current2, flags);
                        ...
                        case "meta":
                          if (hoistableRoot = getHydratableHoistableCache(
                            ...
                            "content",
                            root2
                          ).get(current2 + (flags.content || ""))) {
                            for (i = 0; i < hoistableRoot.length; i++)
                              if (lanes = hoistableRoot[i], checkAttributeStringCoercion(
                                flags.content,
                                "content"
                              ), lanes.getAttribute("content") === (null == flags.content ? null : "" + flags.content) && lanes.getAttribute("name") === (null == flags.name ? null : flags.name) && lanes.getAttribute("property") === (null == flags.property ? null : flags.property) && lanes.getAttribute("http-equiv") === (null == flags.httpEquiv ? null : flags.httpEquiv) && lanes.getAttribute("charset") === (null == flags.charSet ? null : flags.charSet)) {
                                hoistableRoot.splice(i, 1);
                                break b;
                              }
                          }
                        ...
                        default:
                          throw Error(
                            'getNodesForType encountered a type it did not expect: "' + current2 + '". This is a bug in React.'
                          );
                      }
                      lanes[internalInstanceKey] = finishedWork;
                      markNodeAsHoistable(lanes);
                    ...
                    finishedWork.stateNode = current2;
                  } else
                    mountHoistable(
                      hoistableRoot,
                      finishedWork.type,
          ...
          case 3:
            ...
            break;
          case 4:
            current2 = currentHoistableRoot;
            currentHoistableRoot = getHoistableRoot(
              finishedWork.stateNode.containerInfo
            );
            recursivelyTraverseMutationEffects(root2, finishedWork, lanes);
            commitReconciliationEffects(finishedWork);
            currentHoistableRoot = current2;
            break;
          case 12:
            current2 = pushNestedEffectDurations();
            recursivelyTraverseMutationEffects(root2, finishedWork, lanes);
            commitReconciliationEffects(finishedWork);
            finishedWork.stateNode.effectDuration += bubbleNestedEffectDurations(current2);
            break;
          case 13:
            recursivelyTraverseMutationEffects(root2, finishedWork, lanes);
            commitReconciliationEffects(finishedWork);
            finishedWork.child.flags & 8192 && null !== finishedWork.memoizedState !== (null !== current2 && null !== current2.memoizedState) && (globalMostRecentFallbackTime = now$1());
            flags & 4 && (current2 = finishedWork.updateQueue, null !== current2 && (finishedWork.updateQueue = null, attachSuspenseRetryListeners(finishedWork, current2)));
            break;
          case 22:
            flags & 512 && (offscreenSubtreeWasHidden || null === current2 || safelyDetachRef(current2, current2.return));
            ...
            if (flags & 8192 && (root2._visibility = hoistableRoot ? root2._visibility & ~OffscreenVisible : root2._visibility | OffscreenVisible, hoistableRoot && (null === current2 || wasHidden || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || recursivelyTraverseDisappearLayoutEffects(finishedWork)), null === finishedWork.memoizedProps || "manual" !== finishedWork.memoizedProps.mode))
              a: for (current2 = null, root2 = finishedWork; ; ) {
                if (5 === root2.tag || 26 === root2.tag) {
                  if (null === current2) {
                    lanes = current2 = root2;
                    try {
                      i = lanes.stateNode, hoistableRoot ? runWithFiberInDEV(lanes, hideInstance, i) : runWithFiberInDEV(
                        lanes,
                        unhideInstance,
                        lanes.stateNode,
                        lanes.memoizedProps
                  ...
                  if (null === current2) {
                    ...
                    try {
                      ...
                      hoistableRoot ? runWithFiberInDEV(lanes, hideTextInstance, instance) : runWithFiberInDEV(
                        lanes,
                        unhideTextInstance,
                        instance,
                        lanes.memoizedProps
            ...
            flags & 4 && (current2 = finishedWork.updateQueue, null !== current2 && (flags = current2.retryQueue, null !== flags && (current2.retryQueue = null, attachSuspenseRetryListeners(finishedWork, flags))));
            break;
          case 19:
            recursivelyTraverseMutationEffects(root2, finishedWork, lanes);
            commitReconciliationEffects(finishedWork);
          ...
          case 30:
            ...
            recursivelyTraverseMutationEffects(root2, finishedWork, lanes);
            commitReconciliationEffects(finishedWork);
            (lanes & 335544192) === lanes && null !== current2 && viewTransitionMutationContext && (finishedWork.flags |= 4);
      ...
      function commitAfterMutationEffectsOnFiber(finishedWork, root2) {
        ...
        if (null === current2) commitEnterViewTransitions(finishedWork);
        else
          switch (finishedWork.tag) {
            case 3:
              ...
              if (!viewTransitionContextChanged) {
                ...
                if (null !== finishedWork)
                  for (var i = 0; i < finishedWork.length; i += 3) {
                    var instance = finishedWork[i], oldName = finishedWork[i + 1];
            ...
            case 5:
              ...
              break;
            case 22:
              null === finishedWork.memoizedState && (null !== current2.memoizedState ? commitEnterViewTransitions(finishedWork) : recursivelyTraverseAfterMutationEffects(root2, finishedWork));
              break;
            case 30:
              if (0 !== (finishedWork.subtreeFlags & 8246)) {
                ...
                a: {
                  ...
                  viewTransitionHostInstanceIdx !== (null === root2 ? 0 : root2.length) && (finishedWork.flags |= 32);
                }
                0 !== (finishedWork.flags & 4) && current2 ? (current2 = finishedWork.memoizedProps, scheduleViewTransitionEvent(
                  finishedWork,
                  i || viewTransitionContextChanged ? current2.onUpdate : current2.onLayout
                ), viewTransitionCancelableChildren = instance) : null !== instance && (instance.push.apply(
                  instance,
                  viewTransitionCancelableChildren
                ), viewTransitionCancelableChildren = instance);
                viewTransitionContextChanged = 0 !== (finishedWork.flags & 32) ? true : oldName;
              }
              break;
            default:
              recursivelyTraverseAfterMutationEffects(root2, finishedWork);
      ...
      function disappearLayoutEffects(finishedWork) {
        var prevEffectStart = pushComponentEffectStart(), prevEffectErrors = pushComponentEffectErrors();
        switch (finishedWork.tag) {
          case 0:
          case 11:
          case 14:
      ...
      function recursivelyTraversePassiveMountEffects(root2, parentFiber, committedLanes, committedTransitions, endTime) {
        var isViewTransitionEligible = (committedLanes & 335544192) === committedLanes;
      ...
      function commitPassiveMountOnFiber(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) {
        ...
        var isViewTransitionEligible = (committedLanes & 335544192) === committedLanes;
        isViewTransitionEligible && null === finishedWork.alternate && null !== finishedWork.return && null !== finishedWork.return.alternate && restoreEnterViewTransitions(finishedWork);
        var flags = finishedWork.flags;
        switch (finishedWork.tag) {
          case 0:
          case 11:
          ...
          case 1:
            ...
            break;
          case 3:
            var prevEffectDuration = pushNestedEffectDurations(), wasInHydratedSubtree = inHydratedSubtree;
            ...
            isViewTransitionEligible && (committedLanes = finishedRoot.containerInfo, committedLanes = 9 === committedLanes.nodeType ? committedLanes.documentElement : committedLanes.ownerDocument.documentElement, null !== committedLanes && "none" === committedLanes.style.viewTransitionName && (committedLanes.style.viewTransitionName = ""));
          ...
          case 13:
            ...
            prevEffectDuration = null !== finishedWork.alternate ? finishedWork.alternate.memoizedState : null;
            isViewTransitionEligible = finishedWork.memoizedState;
            null === prevEffectDuration || null === prevEffectDuration.dehydrated || null !== isViewTransitionEligible && null !== isViewTransitionEligible.dehydrated ? inHydratedSubtree = false : (isViewTransitionEligible = finishedWork.deletions, null !== isViewTransitionEligible && 0 < isViewTransitionEligible.length && 18 === isViewTransitionEligible[0].tag ? (inHydratedSubtree = false, prevEffectDuration = prevEffectDuration.hydrationErrors, null !== prevEffectDuration && logComponentErrored(
              finishedWork,
              finishedWork.actualStartTime,
              endTime,
              prevEffectDuration
          ...
          case 22:
            ...
            null !== finishedWork.memoizedState ? (isViewTransitionEligible && null !== wasInHydratedSubtree && null === wasInHydratedSubtree.memoizedState && restoreExitViewTransitions(wasInHydratedSubtree), prevEffectDuration._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(
              finishedRoot,
              finishedWork,
              committedLanes,
              committedTransitions,
              ...
              committedTransitions,
              endTime
            )) : (isViewTransitionEligible && null !== wasInHydratedSubtree && null !== wasInHydratedSubtree.memoizedState && restoreEnterViewTransitions(finishedWork), prevEffectDuration._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(
              finishedRoot,
              finishedWork,
              committedLanes,
              committedTransitions,
          ...
          case 24:
            ...
            break;
          case 30:
            isViewTransitionEligible && (flags = finishedWork.alternate, null !== flags && 0 !== (finishedWork.subtreeFlags & 8246) && (finishedWork.memoizedState = null, restoreViewTransitionOnHostInstances(flags.child, true), restoreViewTransitionOnHostInstances(finishedWork.child, true)));
            recursivelyTraversePassiveMountEffects(
              finishedRoot,
              finishedWork,
              committedLanes,
      ...
      function recursivelyTraverseAtomicPassiveEffects(finishedRoot$jscomp$0, parentFiber, committedLanes$jscomp$0, committedTransitions$jscomp$0, endTime$jscomp$0) {
        if (parentFiber.subtreeFlags & 10256)
          for (var child = parentFiber.child; null !== child; ) {
            ...
            var finishedRoot = finishedRoot$jscomp$0, committedLanes = committedLanes$jscomp$0, committedTransitions = committedTransitions$jscomp$0, endTime = null !== parentFiber ? parentFiber.actualStartTime : endTime$jscomp$0;
      ...
      function commitPassiveUnmountEffectsInsideOfDeletedTree_begin(deletedSubtreeRoot, nearestMountedAncestor$jscomp$0) {
        for (; null !== nextEffect; ) {
          var fiber = nextEffect, current2 = fiber, nearestMountedAncestor = nearestMountedAncestor$jscomp$0, prevEffectStart = pushComponentEffectStart(), prevEffectErrors = pushComponentEffectErrors();
          switch (current2.tag) {
            case 0:
            case 11:
            case 15:
          ...
          (current2.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && 0.05 < componentEffectDuration && logComponentEffect(
            current2,
            componentEffectStartTime,
            componentEffectEndTime,
            componentEffectDuration,
          ...
          if (null !== current2) current2.return = fiber, nextEffect = current2;
            ...
            a: for (fiber = deletedSubtreeRoot; null !== nextEffect; ) {
              ...
              prevEffectErrors = current2.return;
      ...
      function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
        ...
        if ("function" === typeof type)
          ...
          a: switch (type) {
            ...
            case REACT_VIEW_TRANSITION_TYPE:
              return key = createFiber(30, pendingProps, key, mode), key.elementType = REACT_VIEW_TRANSITION_TYPE, key.lanes = lanes, key.stateNode = { autoName: null, paired: null, ref: null }, key;
            default:
      ...
      function getViewTransitionName(props, instance) {
        return null != props.name && "auto" !== props.name ? props.name : instance.autoName;
      }
      ...
      function getViewTransitionClassName(defaultClass, eventClass) {
        ...
        return null == eventClass ? defaultClass : "none" === eventClass ? eventClass : null != defaultClass && "none" !== defaultClass ? defaultClass + " " + eventClass : eventClass;
      }
        ...
        if (0 !== workInProgressRootRenderLanes && null !== workInProgress) {
          ...
          switch (yieldReason) {
            ...
            case SuspendedOnData:
              ...
              supportsUserTiming && (reusableComponentDevToolDetails.color = "primary-light", reusableComponentOptions.start = startTime, reusableComponentOptions.end = yieldEndTime, performance.measure("Suspended", reusableComponentOptions));
              break;
            case SuspendedOnAction:
              startTime = yieldStartTime;
              supportsUserTiming && (reusableComponentDevToolDetails.color = "primary-light", reusableComponentOptions.start = startTime, reusableComponentOptions.end = yieldEndTime, performance.measure("Action", reusableComponentOptions));
              break;
            default:
              if (startTime = yieldStartTime, supportsUserTiming) {
                var yieldDuration = yieldEndTime - startTime;
                1 > yieldDuration || (reusableComponentDevToolDetails.color = 5 > yieldDuration ? "primary-light" : 10 > yieldDuration ? "primary" : 100 > yieldDuration ? "primary-dark" : "error", reusableComponentOptions.start = startTime, reusableComponentOptions.end = yieldEndTime, performance.measure("Blocked", reusableComponentOptions));
              }
          }
        }
        yieldDuration = (forceSync = !forceSync && 0 === (lanes & 60) && 0 === (lanes & root2.expiredLanes) || checkIfRootIsPrerendering(root2, lanes)) ? renderRootConcurrent(root2, lanes) : renderRootSync(root2, lanes, true);
        ...
        do {
          if (yieldDuration === RootInProgress) {
            ...
            if (renderWasConcurrent && !isRenderConsistentWithExternalStores(yieldEndTime)) {
              ...
              supportsUserTiming && (reusableLaneDevToolDetails.color = "error", reusableLaneOptions.start = yieldEndTime, reusableLaneOptions.end = yieldDuration, performance.measure("Teared Render", reusableLaneOptions));
              finalizeRender(lanes, startTime);
              yieldDuration = renderRootSync(root2, lanes, false);
            ...
            if (yieldDuration === RootErrored) {
              ...
              if (0 !== errorRetryLanes) {
                ...
                a: {
                  ...
                  var wasRootDehydrated = startTime.current.memoizedState.isDehydrated;
                  wasRootDehydrated && (prepareFreshStack(startTime, errorRetryLanes).flags |= 256);
                  ...
                  if (errorRetryLanes !== RootErrored) {
                    ...
                    null !== startTime && (null === workInProgressRootRecoverableErrors ? workInProgressRootRecoverableErrors = startTime : workInProgressRootRecoverableErrors.push.apply(
                      workInProgressRootRecoverableErrors,
                      startTime
                    ));
                  }
            ...
            a: {
              ...
              switch (yieldDuration) {
                ...
                case RootSuspendedAtTheShell:
                  ...
                  finalizeRender(lanes, startTime);
                  yieldEndTime = lanes;
                  0 !== (yieldEndTime & 3) || 0 !== (yieldEndTime & 60) ? blockingSuspendedTime = startTime : 0 !== (yieldEndTime & 4194176) && (transitionSuspendedTime = startTime);
                  markRootSuspended(
                    forceSync,
                    lanes,
                    workInProgressDeferredLane,
      ...
      function commitRootWhenReady(root2, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        var subtreeFlags = finishedWork.subtreeFlags, isViewTransitionEligible = (lanes & 335544192) === lanes;
        if (isViewTransitionEligible || subtreeFlags & 8192 || 16785408 === (subtreeFlags & 16785408)) {
          suspendedState = { stylesheets: null, count: 0, unsuspend: noop };
          appearingViewTransitions = null;
          accumulateSuspenseyCommitOnFiber(finishedWork);
          if (isViewTransitionEligible) {
            isViewTransitionEligible = root2.containerInfo;
            if (null === suspendedState)
              throw Error(
                "Internal React Error: suspendedState null when it was expected to exists. Please report this as a React bug."
              );
            subtreeFlags = suspendedState;
            isViewTransitionEligible = (9 === isViewTransitionEligible.nodeType ? isViewTransitionEligible : isViewTransitionEligible.ownerDocument).__reactViewTransition;
            null != isViewTransitionEligible && (subtreeFlags.count++, subtreeFlags = onUnsuspend.bind(subtreeFlags), isViewTransitionEligible.finished.then(subtreeFlags, subtreeFlags));
          }
      ...
      function prepareFreshStack(root2, lanes) {
        supportsUserTiming && (performance.mark("Blocking Track", blockingLaneMarker), performance.mark("Transition Track", transitionLaneMarker), performance.mark("Suspense Track", suspenseLaneMarker), performance.mark("Idle Track", idleLaneMarker));
        ...
        if (0 !== workInProgressRootRenderLanes && 0 < previousRenderStartTime) {
          ...
          if (workInProgressRootExitStatus === RootSuspended || workInProgressRootExitStatus === RootSuspendedWithDelay)
            ...
            supportsUserTiming && (reusableLaneDevToolDetails.color = (lanes & 738197589) === lanes ? "tertiary-dark" : "primary-dark", reusableLaneOptions.start = previousRenderStartTime, reusableLaneOptions.end = endTime, performance.measure(
              (lanes & 536870912) === lanes ? "Prewarm" : (lanes & 201326677) === lanes ? "Interrupted Hydration" : "Interrupted Render",
              reusableLaneOptions
            ));
          }
        ...
        if (0 !== (lanes & 3) || 0 !== (lanes & 60)) {
          previousRenderStartTime = 0 <= blockingUpdateTime && blockingUpdateTime < blockingClampTime ? blockingClampTime : blockingUpdateTime;
          endTime = 0 <= blockingEventTime && blockingEventTime < blockingClampTime ? blockingClampTime : blockingEventTime;
          0 <= blockingSuspendedTime && (setCurrentTrackFromLanes(lanes), logSuspendedWithDelayPhase(
            blockingSuspendedTime,
            0 <= endTime ? endTime : 0 <= previousRenderStartTime ? previousRenderStartTime : renderStartTime,
            lanes
          ));
          var eventType = blockingEventType, eventIsRepeat = blockingEventIsRepeat, isSpawnedUpdate = blockingSpawnedUpdate, renderStartTime$jscomp$0 = renderStartTime;
          supportsUserTiming && (reusableLaneDevToolDetails.track = "Blocking", 0 < endTime && null !== eventType && (reusableLaneDevToolDetails.color = eventIsRepeat ? "secondary-light" : "warning", reusableLaneOptions.start = endTime, reusableLaneOptions.end = 0 < previousRenderStartTime ? previousRenderStartTime : renderStartTime$jscomp$0, performance.measure(
            eventIsRepeat ? "" : "Event: " + eventType,
            reusableLaneOptions
          )), 0 < previousRenderStartTime && (reusableLaneDevToolDetails.color = isSpawnedUpdate ? "error" : (lanes & 738197589) === lanes ? "tertiary-light" : "primary-light", reusableLaneOptions.start = previousRenderStartTime, reusableLaneOptions.end = renderStartTime$jscomp$0, performance.measure(
        ...
        0 !== (lanes & 4194176) && (previousRenderStartTime = 0 <= transitionStartTime && transitionStartTime < transitionClampTime ? transitionClampTime : transitionStartTime, endTime = 0 <= transitionUpdateTime && transitionUpdateTime < transitionClampTime ? transitionClampTime : transitionUpdateTime, eventType = 0 <= transitionEventTime && transitionEventTime < transitionClampTime ? transitionClampTime : transitionEventTime, 0 <= transitionSuspendedTime && (setCurrentTrackFromLanes(lanes), logSuspendedWithDelayPhase(
          ...
          reusableLaneOptions
        )), 0 < previousRenderStartTime && (reusableLaneDevToolDetails.color = "primary-dark", reusableLaneOptions.start = previousRenderStartTime, reusableLaneOptions.end = 0 < endTime ? endTime : renderStartTime$jscomp$0, performance.measure("Action", reusableLaneOptions)), 0 < endTime && (reusableLaneDevToolDetails.color = "primary-light", reusableLaneOptions.start = endTime, reusableLaneOptions.end = renderStartTime$jscomp$0, performance.measure("Blocked", reusableLaneOptions))), transitionSuspendedTime = transitionUpdateTime = transitionStartTime = -1.1, transitionEventIsRepeat = true);
        ...
        if (0 !== endTime)
          for (root2 = root2.entanglements, endTime &= lanes; 0 < endTime; )
            eventType = 31 - clz32(endTime), eventIsRepeat = 1 << eventType, lanes |= root2[eventType], endTime &= ~eventIsRepeat;
      ...
      function commitRoot(root2, finishedWork, lanes, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        if (null !== finishedWork) {
          ...
          (lanes & 335544192) === lanes ? (pendingTransitionTypes = ReactSharedInternals.V, ReactSharedInternals.V = null, recoverableErrors = 10262) : (pendingTransitionTypes = null, recoverableErrors = 10256);
          0 !== finishedWork.actualDuration || 0 !== (finishedWork.subtreeFlags & recoverableErrors) || 0 !== (finishedWork.flags & recoverableErrors) ? (root2.callbackNode = null, root2.callbackPriority = 0, scheduleCallback$1(NormalPriority$1, function() {
          ...
          commitErrors = null;
          commitStartTime = now();
          suspendedCommitReason === SUSPENDED_COMMIT ? logSuspendedCommitPhase(completedRenderEndTime, commitStartTime) : suspendedCommitReason === THROTTLED_COMMIT && logSuspenseThrottlePhase(completedRenderEndTime, commitStartTime);
          ...
          shouldStartViewTransition && startViewTransition(
            root2.containerInfo,
      ...
      function flushLayoutEffects() {
        if (pendingEffectsStatus === PENDING_LAYOUT_PHASE) {
          ...
          if (0 !== (finishedWork.subtreeFlags & 8772) || rootHasLayoutEffect) {
            ...
            executionContext |= CommitContext;
            try {
              inProgressLanes = lanes, inProgressRoot = root2, resetComponentEffectTimers(), commitLayoutEffectOnFiber(
                root2,
                finishedWork.alternate,
                finishedWork
              ), inProgressRoot = inProgressLanes = null;
      ...
      function flushSpawnedWork() {
        if (pendingEffectsStatus === PENDING_SPAWNED_WORK || pendingEffectsStatus === PENDING_AFTER_MUTATION_PHASE) {
          pendingEffectsStatus = NO_PENDING_EFFECTS;
          requestPaint();
          var root2 = pendingEffectsRoot, finishedWork = pendingFinishedWork, lanes = pendingEffectsLanes, completedRenderEndTime = pendingEffectsRenderEndTime, recoverableErrors = pendingRecoverableErrors, suspendedCommitReason = pendingSuspendedCommitReason;
          commitEndTime = now();
          completedRenderEndTime = suspendedCommitReason === IMMEDIATE_COMMIT ? completedRenderEndTime : commitStartTime;
          ...
          null !== commitErrors ? logCommitErrored(
            ...
            commitErrors,
            false
          ) : supportsUserTiming && (reusableLaneDevToolDetails.color = "secondary-dark", reusableLaneOptions.start = completedRenderEndTime, reusableLaneOptions.end = suspendedCommitReason, performance.measure("Commit", reusableLaneOptions));
          completedRenderEndTime = (lanes & 335544192) === lanes ? 10262 : 10256;
          (completedRenderEndTime = 0 !== finishedWork.actualDuration || 0 !== (finishedWork.subtreeFlags & completedRenderEndTime) || 0 !== (finishedWork.flags & completedRenderEndTime)) ? pendingEffectsStatus = PENDING_PASSIVE_PHASE : (pendingEffectsStatus = NO_PENDING_EFFECTS, pendingEffectsRoot = null, releaseRootPooledCache(root2, root2.pendingLanes), nestedPassiveUpdateCount = 0, rootWithPassiveNestedUpdates = null);
          suspendedCommitReason = root2.pendingLanes;
          0 === suspendedCommitReason && (legacyErrorBoundariesThatAlreadyFailed = null);
          completedRenderEndTime || commitDoubleInvokeEffectsInDEV(root2);
          ...
          ensureRootIsScheduled(root2);
          suspendedCommitReason = root2.pendingLanes;
          0 !== (lanes & 4194218) && 0 !== (suspendedCommitReason & 42) ? (nestedUpdateScheduled = true, root2 === rootWithNestedUpdates ? nestedUpdateCount++ : (nestedUpdateCount = 0, rootWithNestedUpdates = root2)) : nestedUpdateCount = 0;
      ...
      function flushPassiveEffects(wasDelayedCommit) {
        ...
        try {
          ...
          supportsUserTiming && (reusableLaneDevToolDetails.color = "secondary-light", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure(
          ...
          null !== commitErrors ? logCommitErrored(
            ...
            commitErrors,
            true
          ) : supportsUserTiming && (reusableLaneDevToolDetails.color = "secondary-dark", reusableLaneOptions.start = finishedWork$jscomp$0, reusableLaneOptions.end = passiveEffectsEndTime, performance.measure("Remaining Effects", reusableLaneOptions));
      ...
      function pingSuspendedRoot(root2, wakeable, pingedLanes) {
        ...
        0 !== (pingedLanes & 3) || 0 !== (pingedLanes & 60) ? 0 > blockingUpdateTime && (blockingClampTime = blockingUpdateTime = now()) : 0 !== (pingedLanes & 4194176) && 0 > transitionUpdateTime && (transitionClampTime = transitionUpdateTime = now());
      ...
      function removeChildFromContainer(container, child) {
        switch (container.nodeType) {
          ...
          case 9:
            ...
            break;
          default:
            container = "HTML" === container.nodeName ? container.ownerDocument.body : container;
        }
      ...
      function restoreViewTransitionName(instance, props) {
        ...
        instance.style.viewTransitionName = null == viewTransitionName || "boolean" === typeof viewTransitionName ? "" : ("" + viewTransitionName).trim();
        props = null != props ? props.hasOwnProperty("viewTransitionClass") ? props.viewTransitionClass : props.hasOwnProperty("view-transition-class") ? props["view-transition-class"] : null : null;
        instance.style.viewTransitionClass = null == props || "boolean" === typeof props ? "" : ("" + props).trim();
      }
      function measureInstance(instance) {
        var ownerWindow = instance.ownerDocument.defaultView, rect = instance.getBoundingClientRect();
        instance = getComputedStyle(instance);
        return {
          rect,
          abs: "absolute" === instance.position || "fixed" === instance.position,
          clip: "none" !== instance.clipPath || "visible" !== instance.overflow || "none" !== instance.filter || "none" !== instance.mask || "none" !== instance.mask || "0px" !== instance.borderRadius,
          view: 0 <= rect.bottom && 0 <= rect.right && rect.top <= ownerWindow.innerHeight && rect.left <= ownerWindow.innerWidth
        };
      }
      function startViewTransition(rootContainer, transitionTypes, mutationCallback, layoutCallback, afterMutationCallback, spawnedWorkCallback, passiveCallback) {
        ...
        try {
          var transition = ownerDocument.startViewTransition({
            update: function() {
              ...
              ownerWindow = ownerWindow.navigation && ownerWindow.navigation.transition;
              var previousFontLoadingStatus = ownerDocument.fonts.status;
              mutationCallback();
              if ("loaded" === previousFontLoadingStatus && (ownerDocument.documentElement.clientHeight, "loading" === ownerDocument.fonts.status))
                return previousFontLoadingStatus = Promise.race([
                  ownerDocument.fonts.ready,
                  new Promise(function(resolve) {
                    return setTimeout(resolve, SUSPENSEY_FONT_TIMEOUT);
                  })
                ]).then(layoutCallback, layoutCallback), (ownerWindow ? Promise.allSettled([
                  ownerWindow.finished,
                  previousFontLoadingStatus
                ]) : previousFontLoadingStatus).then(afterMutationCallback, afterMutationCallback);
              layoutCallback();
              if (ownerWindow)
          ...
          transition.ready.then(void 0, function(reason) {
            "object" === typeof reason && null !== reason && "TimeoutError" === reason.name && console.error(
      ...
      function updateContainerImpl(rootFiber, lane, element, container, parentComponent, callback) {
        ...
        null !== element && (startUpdateTimerByLane(lane), scheduleUpdateOnFiber(element, rootFiber, lane), entangleTransitions(element, rootFiber, lane));
      }
      ...
      var REACT_OFFSCREEN_TYPE = Symbol.for("react.offscreen"), REACT_LEGACY_HIDDEN_TYPE = Symbol.for("react.legacy_hidden");
      Symbol.for("react.tracing_marker");
      var REACT_MEMO_CACHE_SENTINEL = Symbol.for("react.memo_cache_sentinel"), REACT_POSTPONE_TYPE = Symbol.for("react.postpone"), REACT_VIEW_TRANSITION_TYPE = Symbol.for("react.view_transition"), MAYBE_ITERATOR_SYMBOL = Symbol.iterator, ASYNC_ITERATOR = Symbol.asyncIterator, REACT_CLIENT_REFERENCE = Symbol.for("react.client.reference"), isArrayImpl = Array.isArray, ReactSharedInternals = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, ReactDOMSharedInternals = ReactDOM.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, NotPending = Object.freeze({
        pending: false,
        data: null,
        method: null,
        action: null
      ...
      ), illegalAttributeNameCache = {}, validatedAttributeNameCache = {}, viewTransitionMutationContext = false, disabledDepth = 0, prevLog, prevInfo, prevWarn, prevError, prevGroup, prevGroupCollapsed, prevGroupEnd;
      ...
      var ANIMATION_END = getVendorPrefixedEventName("animationend"), ANIMATION_ITERATION = getVendorPrefixedEventName("animationiteration"), ANIMATION_START = getVendorPrefixedEventName("animationstart"), TRANSITION_RUN = getVendorPrefixedEventName("transitionrun"), TRANSITION_START = getVendorPrefixedEventName("transitionstart"), TRANSITION_CANCEL = getVendorPrefixedEventName("transitioncancel"), TRANSITION_END = getVendorPrefixedEventName("transitionend"), topLevelEventsToReactNames = /* @__PURE__ */ new Map(), simpleEventPluginEvents = "abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll scrollEnd toggle touchMove waiting wheel".split(
        " "
      ), CapturedStacks = /* @__PURE__ */ new WeakMap(), OffscreenVisible = 1, OffscreenDetached = 2, OffscreenPassiveEffectsConnected = 4, concurrentQueues = [], concurrentQueuesIndex = 0, concurrentlyUpdatedLanes = 0, emptyContextObject = {};
      Object.freeze(emptyContextObject);
      var resolveFamily = null, failedBoundaries = null, NoMode = 0, ConcurrentMode = 1, ProfileMode = 2, StrictLegacyMode = 8, StrictEffectsMode = 16, NoStrictPassiveEffectsMode = 64, now = Scheduler.unstable_now, renderStartTime = -0, commitStartTime = -0, commitEndTime = -0, commitErrors = null, profilerStartTime = -1.1, profilerEffectDuration = -0, componentEffectDuration = -0, componentEffectStartTime = -1.1, componentEffectEndTime = -1.1, componentEffectErrors = null, blockingClampTime = -0, blockingUpdateTime = -1.1, blockingEventTime = -1.1, blockingEventType = null, blockingEventIsRepeat = false, blockingSpawnedUpdate = false, blockingSuspendedTime = -1.1, transitionClampTime = -0, transitionStartTime = -1.1, transitionUpdateTime = -1.1, transitionEventTime = -1.1, transitionEventType = null, transitionEventIsRepeat = false, transitionSuspendedTime = -1.1, yieldReason = 0, yieldStartTime = -1.1, currentUpdateIsNested = false, nestedUpdateScheduled = false, supportsUserTiming = "undefined" !== typeof performance && "function" === typeof performance.measure, COMPONENTS_TRACK = "Components ⚛", reusableComponentDevToolDetails = {
        color: "primary",
        track: COMPONENTS_TRACK
      ...
      }, LANES_TRACK_GROUP = "Scheduler ⚛", reusableLaneDevToolDetails = {
        color: "primary",
        track: "Blocking",
        trackGroup: LANES_TRACK_GROUP
      }, reusableLaneOptions = {
      ...
      var rendererSigil = {};
      var currentlyRenderingFiber$1 = null, lastContextDependency = null, isDisallowedContextReadInDEV = false, currentEntangledListeners = null, currentEntangledPendingCount = 0, currentEntangledLane = 0, currentEntangledActionThenable = null, UpdateState = 0, ReplaceState = 1, ForceUpdate = 2, CaptureUpdate = 3, hasForceUpdate = false;
      var didWarnUpdateInsideUpdate = false;
      var currentlyProcessingQueue = null;
      var didReadFromEntangledAsyncAction = false, NoFlags = 0, HasEffect = 1, Insertion = 2, Layout = 4, Passive = 8, AbortControllerLocal = "undefined" !== typeof AbortController ? AbortController : function() {
      ...
      var classComponentUpdater = {
        enqueueSetState: function(inst, payload, callback) {
          ...
          null !== payload && (startUpdateTimerByLane(lane), scheduleUpdateOnFiber(payload, inst, lane), entangleTransitions(payload, inst, lane));
        },
        ...
        enqueueForceUpdate: function(inst, callback) {
          ...
          null !== callback && (startUpdateTimerByLane(lane), scheduleUpdateOnFiber(callback, inst, lane), entangleTransitions(callback, inst, lane));
        }
      }, forkStack = [], forkStackIndex = 0, treeForkProvider = null, treeForkCount = 0, idStack = [], idStackIndex = 0, treeContextProvider = null, treeContextId = 1, treeContextOverflow = "", SuspenseException = Error(
      ...
      }, suspendedThenable = null, needsToResetSuspendedThenableDEV = false, currentTreeHiddenStackCursor = createCursor(null), prevEntangledRenderLanesCursor = createCursor(0), prevOnStartTransitionFinish = ReactSharedInternals.S;
      ...
      var renderLanes = 0, currentlyRenderingFiber = null, currentHook = null, workInProgressHook = null, didScheduleRenderPhaseUpdate = false, didScheduleRenderPhaseUpdateDuringThisPass = false, shouldDoubleInvokeUserFnsInHooksDEV = false, localIdCounter = 0, thenableIndexCounter$1 = 0, thenableState$1 = null, globalClientIdCounter$1 = 0, RE_RENDER_LIMIT = 25, currentHookNameInDev = null, hookTypesDev = null, hookTypesUpdateIndexDev = -1, ignorePreviousDependencies = false, ContextOnlyDispatcher = {
        readContext,
        use,
      ...
      var offscreenSubtreeIsHidden = false, offscreenSubtreeWasHidden = false, needsFormReset = false, PossiblyWeakSet = "function" === typeof WeakSet ? WeakSet : Set, nextEffect = null, inProgressLanes = null, inProgressRoot = null, shouldStartViewTransition = false, appearingViewTransitions = null, viewTransitionContextChanged = false, viewTransitionCancelableChildren = null, viewTransitionHostInstanceIdx = 0, hostParent = null, hostParentIsContainer = false, currentHoistableRoot = null, inHydratedSubtree = false, suspenseyCommitFlag = 8192;
      ...
      var hydrationParentFiber = null, nextHydratableInstance = null, isHydrating = false, didSuspendOrErrorDEV = false, hydrationDiffRootDEV = null, hydrationErrors = null, rootOrSingletonContext = false, HydrationMismatchException = Error(
        "Hydration Mismatch Exception: This is not a real error, and should not leak into userspace. If you're seeing this, it's likely a bug in React."
      ), globalClientIdCounter = 0, DefaultAsyncDispatcher = {
      ...
      } : scheduleTimeout, SUSPENSEY_FONT_TIMEOUT = 500;
      ...
      var NotLoaded = 0, Loaded = 1, Errored = 2, Settled = 3, Inserted = 4, preloadPropsMap = /* @__PURE__ */ new Map(), preconnectsSet = /* @__PURE__ */ new Set(), previousDispatcher = ReactDOMSharedInternals.d;
      ...
      if (!function() {
        var internals = {
          bundleType: 1,
          version: "19.1.0-experimental-9ff42a87-20250130",
          rendererPackageName: "react-dom",
          currentDispatcherRef: ReactSharedInternals,
          reconcilerVersion: "19.1.0-experimental-9ff42a87-20250130"
        };
