  ...
  "node_modules/react-server-dom-webpack/cjs/react-server-dom-webpack-client.browser.development.js"(exports) {
    ...
    (function() {
      ...
      function createBoundServerReference(metaData, callServer, encodeFormAction, findSourceMapURL) {
        ...
        registerServerReference(action, { id, bound });
        return action;
      }
      ...
      function flushComponentPerformance(response, root, trackIdx$jscomp$0, trackTime, parentEndTime) {
        ...
        if (trackIdx = root._debugInfo) {
          for (startTime = 1; startTime < trackIdx.length; startTime++)
            if ("string" === typeof trackIdx[startTime].name && (name = trackIdx[startTime - 1], "number" === typeof name.time)) {
              startTime = name.time;
          ...
          for (startTime = trackIdx.length - 1; 0 <= startTime; startTime--)
            name = trackIdx[startTime], "number" === typeof name.time && name.time > parentEndTime && (parentEndTime = name.time);
        }
        startTime = {
        ...
        if (trackIdx) {
          for (parentEndTime = 0, childTrackIdx = true, children = trackIdx.length - 1; 0 <= children; children--)
            if (trackTime = trackIdx[children], "number" === typeof trackTime.time && (parentEndTime = trackTime.time, parentEndTime > name && (name = parentEndTime)), "string" === typeof trackTime.name && 0 < children) {
              ...
              if ("number" === typeof childTrackTime.time) {
                ...
                if (childTrackIdx && "rejected" === root.status && root.reason !== response._closedReason) {
                  ...
                  childTrackIdx = trackIdx$jscomp$0, childEndTime = name, supportsUserTiming && 0 <= childEndTime && 10 > childTrackIdx && (properties = trackTime.env, componentInfo = trackTime.name, rootEnv = properties === response._rootEnvironmentName, error = parentEndTime - childTrackTime, reusableComponentDevToolDetails.color = 0.5 > error ? rootEnv ? "primary-light" : "secondary-light" : 50 > error ? rootEnv ? "primary" : "secondary" : 500 > error ? rootEnv ? "primary-dark" : "secondary-dark" : "error", reusableComponentDevToolDetails.track = trackNames[childTrackIdx], reusableComponentOptions.start = 0 > childTrackTime ? 0 : childTrackTime, reusableComponentOptions.end = childEndTime, performance.measure(
                    rootEnv || void 0 === properties ? componentInfo : componentInfo + " [" + properties + "]",
      ...
      function createResponseFromOptions(options) {
        return new ResponseInstance(
          ...
          options ? false !== options.replayConsoleLogs : true,
      ...
      var REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy"), REACT_POSTPONE_TYPE = Symbol.for("react.postpone"), REACT_VIEW_TRANSITION_TYPE = Symbol.for("react.view_transition"), MAYBE_ITERATOR_SYMBOL = Symbol.iterator, ASYNC_ITERATOR = Symbol.asyncIterator, isArrayImpl = Array.isArray, getPrototypeOf = Object.getPrototypeOf, jsxPropsParents = /* @__PURE__ */ new WeakMap(), jsxChildrenParents = /* @__PURE__ */ new WeakMap(), CLIENT_REFERENCE_TAG = Symbol.for("react.client.reference"), ObjectPrototype = Object.prototype, knownServerReferences = /* @__PURE__ */ new WeakMap(), fakeServerFunctionIdx = 0, v8FrameRegExp = /^ {3} at (?:(.+) \((.+):(\d+):(\d+)\)|(?:async )?(.+):(\d+):(\d+))$/, jscSpiderMonkeyFrameRegExp = /(?:(.*)@)?(.*):(\d+):(\d+)/, supportsUserTiming = "undefined" !== typeof performance && "function" === typeof performance.measure, componentsTrackMarker = {
        ...
        " "
      ), REACT_CLIENT_REFERENCE = Symbol.for("react.client.reference"), prefix, suffix;
      ...
      var initializingHandler = null, initializingChunk = null, supportsCreateTask = !!console.createTask, fakeFunctionCache = /* @__PURE__ */ new Map(), fakeFunctionIdx = 0, createFakeJSXCallStack = {
      ...
      (function(internals) {
        ...
        if (hook.isDisabled || !hook.supportsFlight) return true;
        try {
      ...
      exports.createServerReference = function(id, callServer, encodeFormAction, findSourceMapURL, functionName) {
        ...
        registerServerReference(action, { id, bound: null });
        return action;
      };
